...
export enum ContentTxtKey {
  ...
  GitSkill = 'content.skill.Git',
  GHSkill = 'content.skill.GH',
  WSSkill = 'content.skill.WS',
  FigmaSkill = 'content.skill.Figma',

  SocialNetworkProject = 'content.project.SocialNetwork',
  EasyChartsProject = 'content.project.EasyCharts',
  FutureProjectProject = 'content.project.FutureProject',
  ...
  TechnologySNText = 'content.text.technologySN',
  TechnologyECText = 'content.text.technologyEC',
  TechnologyFPText = 'content.text.technologyFP',
